...
export default (path1, path2) => {
   ...
   keys.forEach((key) => {
      if(obj1[key] === obj2[key]) resultArr.push({ status: 'unchanged', key: key, value: obj1[key]});
      if(_.has(obj1, key) && !_.has(obj2, key)) resultArr.push({ status: 'deleted', key: key, value: obj1[key] });
      if(!_.has(obj1, key) && _.has(obj2, key)) resultArr.push({ status: 'added', key: key, value: obj2[key] });
      if(_.has(obj1, key) && _.has(obj2, key) && obj1[key] !== obj2[key]) resultArr.push({ status: 'changed', key: key, value1: obj1[key], value2: obj2[key] });
   });
